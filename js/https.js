import { axios, installInterceptors, installNextInterceptors, installHelperInterceptors } from './axios'
import { __server, __uc, __cms, __node, __spider, __next, __pay, __helperUrl } from '../data/jx3box.json'
